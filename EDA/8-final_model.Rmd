...
```{r}
oversampled_model <- model_fit_wf(df_train_up, selected_features, outcome_column, lightgbm_parameters)

undersampled_model <- model_fit_wf(df_train_down, selected_features, outcome_column, lightgbm_parameters)
```
